...
<?php change_password($user_id, 'admin/profile.php'); ?>
<?php profile_update($user_id, 'admin/profile.php'); ?>
<?php profile_image_update($user_id, 'admin/profile.php'); ?>
<?php remove_profile_image($user_id, 'admin/profile.php'); ?>

<!-- Begin Page Content -->
<div class="container-fluid">
  <!-- Page Heading -->
  <h1 class="h3"><b>Profile</b></h1>
    ...
    <div class="col-md-3 mb-3">
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="text-center">
          <img src="<?= ROOT_URL . 'images/' . $user_image ?>" style="height: 200px; width:200px; object-fit:cover; border-radius:50%;border:2px solid grey;" class="avatar img-circle m-2" alt="avatar">
    ...
    <div class="col-md-6 personal-info">
      ...
      <form action="" method="POST" class="form-horizontal w-100" role="form">
        <div class="form-group">
          ...
          <div class="col-lg-12">
            <input name="user-name" class="form-control" type="text" value="<?= $user_name ?>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-3 control-label">Username:</label>
          <div class="col-md-12">
            <input name="user-username" class="form-control" type="text" value="<?= $user_username ?>">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-3 control-label">Email:</label>
          <div class="col-lg-12">
            <input name="user-email" class="form-control" type="text" value="<?= $user_email ?>">
          </div>
        </div>
        <div class="form-group">
